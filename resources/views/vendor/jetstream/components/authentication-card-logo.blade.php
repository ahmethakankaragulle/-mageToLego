<svg class="w-16 h-16" version="1.1" id="Icons" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-3.2 -3.2 38.40 38.40" xml:space="preserve" fill="#ff0000" stroke="#ff0000" transform="rotate(0)matrix(1, 0, 0, 1, 0, 0)">
    ...
    <g id="SVGRepo_iconCarrier">
        ...
        <path class="st0" d="M25,15H14c-0.6,0-1,0.4-1,1v5c0,0.6,0.4,1,1,1h11c0.6,0,1-0.4,1-1v-5C26,15.4,25.6,15,25,15z"></path>
