...
.dropbtn {
  ...
  .dropdown-content a:hover {background-color: #C70039; color:#fff;}
...
<nav class="navbar navbar-expand-lg bg-body-tertiary fixed-top" style="background-color:#ffff; -webkit-box-shadow: 0px 5px 20px -18px rgba(0,0,0,0.75);
...
box-shadow: 0px 5px 20px -18px rgba(0,0,0,0.75);">
    <div class="container-fluid">
        ...
        <a href=""><svg fill="#C70039" width="45px" height="45px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M8,3V7H21L18,17H6V4H4A1,1,0,0,1,4,2H7A1,1,0,0,1,8,3ZM6,20.5A1.5,1.5,0,1,0,7.5,19,1.5,1.5,0,0,0,6,20.5Zm9,0A1.5,1.5,0,1,0,16.5,19,1.5,1.5,0,0,0,15,20.5Z"></path></g></svg></a>
